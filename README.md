...
### It'd be _pretty_ handy if I could for which virtual teams a PR is. For instance with a bunch of labels. How do I go about that?
...
a chore, though, so `virtual-code-owners` also has an option to automate that.
